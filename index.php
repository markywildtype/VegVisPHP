...
<head>
    ...
    <title>Vegetarian Visitor <?php echo date('Y') ?> - A guide to vegetarian and vegan accommodation and eating in the
        UK</title>
</head>
<body>
...
<nav class="navbar navbar-expand-lg navbar-dark"
     style="background-color: #003100; font-family: Merriweather Sans, sans-serif;">
...
<div class="container body-content">
    ...
    <div id="selector-div" hidden>
        <div class="btn-group btn-group-toggle btn-group-vertical" id="selector" data-toggle="buttons">
    ...
    <section class="content">
        ...
        <div id="homepage-content">
            ...
            <p>Vegetarian Visitor is an annually updated guide to accommodation and eateries in Britain which take
                catering for vegetarians and vegans seriously.</p>
            <p>With the increasing emphasis on healthy eating, more and more people are looking for places to stay and
                eat that provide for vegetarians. Here we list B&Bs, guest houses, hotels, restaurants, cafés and pubs
                that understand vegetarian and vegan requirements and want to cater for them properly, by providing a
                variety of tasty and imaginative dishes for breakfast, lunch and evening meals.</p>
            <p>Britain has been home to many vegetarian VIPs and celebrities - Paul McCartney, Sir Isaac Newton, H.G.
                Wells, Sting, Tony Benn, Kate Bush, Sir John Gielgud and Jude Law, to name but a few - and its eateries
                serve a truly international range of food, from simple English 'pub grub' through Caribbean, Mexican,
                Indian, Thai and Chinese to French haute cuisine.</p>
            <p>As this guide shows, there is no reason why vegetarians and vegans should miss out!</p>
            <hr/>
            <p>Vegetarian Visitor was for many years, until 2012, published as an award-winning annual guidebook. Since
                2001 it has also been a website.</p>
            <p>Suggestions or requests for inclusion are very welcome. Please use the <a class="contact-button"
                                                                                         id="contact-link" href="#">contact
                    form</a> giving as many details as possible, particularly the establishment's email address and/or
                phone number.</p>
        </div>
        ...
        <div id="contact-content" hidden>
            ...
            <form name="contactform" method="post" action="php/contactform.php" onsubmit="return submitUserForm();">
                <table class="contactform">
                    ...
                    <tr>
                        <td>
                            <input name="name" id="Full_Name" maxlength="80" class="input" type="text"
                                   placeholder="*Name" required>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input name="mail" id="Email_Address" maxlength="100" class="input" type="text"
                                   placeholder="*Email Address" required>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input name="phone" id="Telephone_Number" maxlength="100" class="input" type="text"
                                   placeholder="Phone Number">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <textarea class="input-text" name="message" id="Your_Message" maxlength="2000"
                    ...
                    <tr>
                        <td>
                            <div align="center" class="g-recaptcha"
                                 data-sitekey="6LfTeXgUAAAAAKDFlzTM2QrxqrZSsKgI_cpftQ0u"
